...
<p align="center">
  <img src="images/Boondock100px.png" alt="Boondock Technologies logo" width="100"><br />
...
> ------
> Police, Fire, EMS, and other corporate clients should contact [www.boondockecho.com](www.boondockecho.com) for commercial software options.
> -----
...
Choose the binary for your device variant; TANGO and ECHO firmware are not interchangeable.  

You may install pre-compiled firmware from [www.boondockecho.com](www.boondockecho.com) using the web-flasher.
...
### Firmware fails to upload
- Remove the SD card before flashing firmware.
- Hold the Boot button on the far left of the development board before and for a few seconds after you flash the device.
- Slow down the write speed.  Platform.IO defaults to a very high baud rate.  Slow down to 115200 baud for the write.
- Try a different microUSB cable.  Some cables work fine at low speeds and fail at high speed data transfer.

### Device keeps restarting or complains of SD card issues.
- Use a 32 GB or smaller SD card.
- Remove the SD card and flash it as FAT32.
- Ensure the dip switch settings are set to OFF-ON-ON-OFF-Off ▄ ▀ ▀ ▄ ▄ ▄
- Reflash the firmware.  Sometimes bits are corrupted during the write.


### I don't know what anything on this page means!
- Create a free account at [www.boondockecho.com](www.boondockecho.com) and use the firmware update tool there.  It's free and easy to use.  Use Chrome or Edge on Windows, Mac, or Linux.  (Firefox has issues)
